...
export const FooterPrivacyPolicies: string[] = [
  ...
  'By using Googl Drive Sync, Bandori-Tales will have access to modify your drive data to read and write your site personal data inside bandori-tales folder.',
];
